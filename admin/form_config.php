...
if(!empty($id)){
	...
	$rs = mysql_query('SELECT * FROM tbconfig WHERE id = '.$id);
...
<legend>จัดการข้อมูลเว็บไซต์</legend>
<form class="form-horizontal" action="save_config.php" method="post">
	...
	<div class="control-group">
		...
		<div class="controls">
                    <input type="text" style="width: 250px"name="name" value="<?php echo @$val['name']; ?>" >
		</div>
	</div>
	<div class="control-group">
		<label for="lname" class="control-label">รายละเอียด</label>
		<div class="controls">
			 <textarea rows="20" cols="43" name="detail" id="detail" style="width: 640px"class="txt required"><?php echo @$val['detail']; ?></textarea>
            <script type="text/javascript">
        //<![CDATA[
