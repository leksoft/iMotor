...
$rs = mysql_query('SELECT * FROM tbuser WHERE type = "admin"');
?>
<!-- ปุ่มเพิ่ม -->
<a href="index.php?url=form_user.php" class="btn btn-large btn-info"><i class="icon icon-plus icon-white"></i> เพิ่มผู้ดูแลระบบ</a>
<br><br>
